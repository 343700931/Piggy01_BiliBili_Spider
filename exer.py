...
'''
sql_4 = '''
CREATE TABLE IF NOT EXISTS danmu_test (id INT(8) NOT NULL,user_id VARCHAR(255) NOT NULL,play_time TIME(5) NOT NULL,
dt DATETIME(6) NOT NULL,lenth int(30) NOT NULL,pattern VARCHAR(25) NOT NULL,size VARCHAR(255) NOT NULL,
color VARCHAR(255) NOT NULL,cid INT(255) NOT NULL,detail VARCHAR(255) NOT NULL,url VARCHAR(255) NOT NULL,PRIMARY KEY(id,cid,user_id))
'''

# WARNING 慎用
sql_5 = '''
DROP TABLE danmu_test;
'''
